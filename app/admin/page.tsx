...
const AdminPage = () => {
  ...
  const [profileData, setProfileData] = useState<ProfileData>({ userLogo: '', bio: DEFAULT_BIO });
    ...
    try {
      ...
      if (data) {
        setProfileData({
          ...
          bio: data.bio?.trim() ? data.bio : DEFAULT_BIO
        });
      }
    } catch (error) {

...
const About = () => {
  ...
  const defaultBio = `Software engineer with experience developing cross-platform mobile and web applications using Swift, Java, React.js, Next.js, and Python. Skilled in building interactive user interfaces, migrating legacy frameworks to modern tech stacks, and collaborating with cross-functional teams to deliver scalable, high-quality solutions. Enthusiastic about full stack development and driving operational efficiency through robust API integrations and optimized data workflows.

I completed my bachelor's degree in Computer Science at the Singapore Institute of Technology and have worked as a mobile and web developer for 15 years. I am highly motivated to solve problems in mobile and web projects, and as a collaborative developer I support teammates. My greatest strength is a combination of enthusiasm and persistence.`;
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <div className="max-w-4xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed text-left bg-card border rounded-2xl p-6 md:p-8 shadow-sm">
              {bio ? (
                <div className="whitespace-pre-line">{bio}</div>
              ) : (
                <div className="space-y-4">
                  <p className="whitespace-pre-line">{defaultBio}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="mb-16 md:mb-24">
            <div className="max-w-6xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold mb-10 md:mb-12 flex items-center justify-center gap-3">
                    ...
                    {experiences.map((exp, index) => (
                      <div key={exp.id} className={`relative flex flex-col md:flex-row items-center md:justify-between gap-8 group`}>
                        ...
                        <div className={`w-full md:w-[45%] pl-20 md:pl-0 ${
                          ...
                          <div className={`relative p-5 md:p-6 rounded-2xl bg-card border border-border/50 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 ${
